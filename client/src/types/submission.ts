...
export type Submission = { id: string; userId: string; user?: SubmissionUser; questionSetId: string; status: SubmissionStatus; submittedAt?: string | null; gradedAt?: string | null; totalScore?: number | null; createdAt: string; updatedAt: string; answers: Answer[] };
