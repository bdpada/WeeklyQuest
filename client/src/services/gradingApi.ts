...
export const gradingApi = {
  ...
  finalizeScores: (questionSetId: string) => apiClient<{ questionSetId: string; questionSetStatus: string; gradedSubmissions: number; totalAnswersGraded: number }>(`/question-sets/${questionSetId}/finalize-scores`, { method: 'POST' }),
};
